...
def update_graph(site_dropdown):
    if (site_dropdown == 'All Sites'):
        ...
        fig = px.pie(df, names = 'Launch Site',hole=.3,title = 'Total Sucess Launch On Each Launch Sites')
    else:
        df  = spacex_df[spacex_df['Launch Site'] == site_dropdown]
        fig = px.pie(df, names = 'class',hole=.3,title = 'Total Success Launch On Site '+site_dropdown)
    return fig
